...
def add_in_sem(dept,year,sem,book_name,book_id):
...
def add_in_yr(dept,year,book_name,book_id):
    sem_choice = get_sem_choice()
    if sem_choice == 1:
        add_in_sem(dept,year,"1ST_SEM",book_name,book_id)
    elif sem_choice == 2:
        add_in_sem(dept,year,"2ND_SEM",book_name,book_id)
    else:
